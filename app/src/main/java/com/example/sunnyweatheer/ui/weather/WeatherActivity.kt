...
import com.example.sunnyweatheer.databinding.ActivityMainBinding
import com.example.sunnyweatheer.databinding.ActivityWeatherBinding
import com.example.sunnyweatheer.logic.model.Weather
import com.example.sunnyweatheer.logic.model.getSky
import com.example.sunnyweatheer.ui.weather.WeatherViewModel
...
class WeatherActivity : AppCompatActivity() {
    ...
    private fun showWeatherInfo(weather: Weather) {
        ...
        // 填充now.xml布局中数据
        val currentTempText = "${realtime.temprature.toInt()} ℃"
